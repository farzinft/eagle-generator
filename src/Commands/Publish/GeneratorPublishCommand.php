...
class GeneratorPublishCommand extends PublishBaseCommand
{
    ...
    {
        $apiVersion = config('eagle.eagle_generator.api_version', 'v1');
        $apiPrefix = config('eagle.eagle_generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('eagle.eagle_generator.path.api_test', base_path('tests/'));
