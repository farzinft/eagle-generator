...
namespace Eagle\Generator\Utils;

use DB;
use Eagle\Generator\Common\GeneratorField;
use Eagle\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('eagle.eagle_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('eagle.eagle_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('eagle.eagle_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('eagle.eagle_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('eagle.eagle_generator.timestamps.deleted_at', 'deleted_at');
