...
namespace Eagle\Generator\Generators;
...
use Eagle\Generator\Utils\TableFieldsGenerator;
...
class ModelGenerator extends BaseGenerator
{
     ...
     *
     * @param \Eagle\Generator\Common\CommandData $commandData
     */
    ...
    private function fillSoftDeletes($templateData)
    {
        if (!$this->commandData->getOption('softDelete')) {
            ...
            $deletedAtTimestamp = config('eagle.eagle_generator.timestamps.deleted_at', 'deleted_at');
            $templateData = str_replace(
